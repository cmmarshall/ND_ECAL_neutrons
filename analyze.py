...
def loop( events, tgeo, tree, cluster_gap = 10 ):
    ...
    for ient in range(0, N):
        ...
        for cluster in clusters:
            ...
            sigx, sigy = cluster.getSigma()
            t_nSigmaX[t_nCandidates[0]] = sigx
            t_nSigmaY[t_nCandidates[0]] = sigy
            t_nNlayers[t_nCandidates[0]] = cluster.getNlayers()
            t_nGaps[t_nCandidates[0]] = cluster.getLayerGaps()
...
if __name__ == "__main__":
    ...
    tree.Branch( "nNlayers", t_nNlayers, "nNlayers[nCandidates]/I" )
    tree.Branch( "nGaps", t_nGaps, "nGaps[nCandidates]/I" )
